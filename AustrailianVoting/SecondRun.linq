...
void Main()
{
	...
	string fileToProcess = @"C:\Users\Kim\Documents\LINQPad Queries\files\AustralianVoting-input.txt";
	string outputFile = @"C:\Users\Kim\Documents\LINQPad Queries\files\AustralianVoting-output.txt";
